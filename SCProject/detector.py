...
TRAINING_PATH = "D:/Sandra/Faks/4/Soft/soft_datasets/fer_dataset/Training"
TESTING_PATH = "D:/Sandra/Faks/4/Soft/soft_datasets/fer_dataset/Testing"
...
def write_to_csv(dataset):
    path = "D:/Sandra/Faks/4/Soft/soft_datasets/"

    if MODE == "TRAINING":
        csv_name = path + "dataset.csv"
    elif MODE == "TESTING":
        csv_name = path + "testdata.csv"
